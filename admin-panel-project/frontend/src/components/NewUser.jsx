                ...
                <form>
                  <FormControl sx={{ display: "flex", flexDirection: "column", gap: 3, justifyContent: "center", marginBottom: "20px"}} fullWidth={true}>
                    <Typography sx={{display: "flex", flexDirection: "column", gap: 2,}}>
                        <TextField label={"First Name"} name={"firstname"} type={"text"} fullWidth={true}/>
                        <TextField label={"Last Name"} name={"lastname"} type={"text"} fullWidth={true}/>
                        <TextField label={"Phone Number"} name={"number"} type={"number"} fullWidth={true}/>
                        <TextField label={"E-Mail"} name={"email"} type={"text"} fullWidth={true}/>
                    </Typography>
                  </FormControl>
                    ...
                    <br/>
                    <p>Disabled</p>
                    <FormControlLabel value="male" control={<Checkbox />}/>
                    <br/>
                    <p>Avatar</p>
